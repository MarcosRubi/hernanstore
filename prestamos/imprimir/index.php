...
$primerFormato = [
    ...
    "txtFecha" => $DatosPrestamo["fecha_prestamo"],
    ...
    "txtValorCuota" => $DatosPrestamo["valor_cuota"],
    "txtIdPrestamo" => $DatosPrestamo["id_prestamo"],
    "txtGanancia" => $DatosPrestamo["ganancias"],
];
