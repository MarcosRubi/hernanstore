...
if ($Res_Cuotas) {
    ...
    $Res_UltimaFechaPago = $Obj_Cuotas->RecuperarFechaUltimoPago($_GET['id']);
    $Obj_Prestamos->ActualizarFechaSiguentePago($Res_UltimaFechaPago->fetch_assoc()['fecha_pago'], $_GET['id_prestamo']);
