...
$Nombre = strip_tags(ucfirst(strtolower(trim($_POST['txtNombre']))));
$Telefono = strip_tags(trim(str_replace("_", "", $_POST['txtTelefono'])));
$Direccion = strip_tags(ucwords(strtolower(trim($_POST['txtDireccion']))));
$Informacion =  '<p><br>
